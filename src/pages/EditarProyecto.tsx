 ...
 *
 * Objetivo:
 *     Mostrar modal de justificación antes de actualizar el proyecto.
 *
 * Parámetros:
 *     - event: evento de formulario del navegador.
 *
 * Operación:
 *     - Previene el envío directo del formulario.
 *     - Muestra el modal para capturar justificación del usuario.
 */
  ...
  /**
   * Maneja la confirmación del modal de justificación
   * 
   * Objetivo:
   *     Ejecutar la actualización del proyecto con la justificación proporcionada.
   * 
   * Parámetros:
  ...
  return (
    <div className="nuevo-proyecto-wrapper">
      ...
      <JustificacionModal
        ...
        title="Justificación de Cambios en Proyecto"
